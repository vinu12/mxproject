...
?>
    ...
    <script type="text/javascript">
        ...
        Stripe.setPublishableKey('pk_test_TpwU7vwXwjDigb4RPdjO90uz006ah4NNtZ');
                    ...
                    <div id="payment-errors"></div>  
                     <form method="post" id="paymentFrm" enctype="multipart/form-data" action="<?php echo base_url();?>payment/check">
                        <div class="form-group">
                            <input type="text" name="name" class="form-control" placeholder="Name" value="<?php echo $uname; ?>" required>
                        </div>  
