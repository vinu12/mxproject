<div class="container">
    <div class="section">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <div class="col-lg-12 ntwrk-heding nopadd">
                            <div class="col-lg-12 ntwrk-ttl nopadd">  <span> Following (<?php echo $countfollowing['0']['following']; ?>) </span>  </div>
                            ...
                            foreach ($user_result as $key => $userData) {
                                ...
                                $resultData = $CI->Users_model->listUsercheck($userData['followerid']);

                                foreach ($resultData as $record) {
                                    ?>
                                    <div class="col-lg-4 ntwrk-usr"> <a href="<?php echo base_url(); ?>UserNetwork/profile/<?php echo base64_encode($userData['followerid']); ?>"> 
                                    <?php 
        ...
        if ($logid != "") {
            ...
            $CI = & get_instance();
            $CI->load->model('Users_model');
            $resultDatasecond = $CI->Users_model->checkfollowinguser($userid);
          
          

            if ($userid == $resultDatasecond) {
                ?>
                                                    <div id='followu<?php echo $userid; ?>'>
                                                        <a  id='unfollowdata<?php echo $userid; ?>' href="javascript:void(0);" onclick="unfollowData(<?php echo $userid; ?>);" ><button   class="follow-userside ntwrk-flw-btn"> Following  </button> </a> 
        ...
        ?>
                                    ...
                                    {
										?>
                                        <div align="center">NO following users</div>
										<?php
                                    }
                                    ?>							
