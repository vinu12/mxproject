...
<div class="box box-primary">
                    ...
                    <form role="form" id="addUser" action="<?php echo base_url() ?>admin_adminusers/addsubcategory" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">  
                                ...
                                <div class="col-md-6">
                                 <div class="form-group">
                                        ...
                                        <input type="text" class="form-control " value="<?php echo $subcatdata->Category; ?>" id="categoryname" name="categoryname" maxlength="128" autocomplete="off"  required>
                                    </div>
