	  ...
	  <div class="row">
            <div class="col-xs-6 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>admin_adminusers/cumulativelist"> Home</a>
                </div>
            </div>
			
			<div class="col-xs-6 text-left">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>admin_adminusers/addsubcategory/<?php echo $top_catid; ?>"><i class="fa fa-plus"></i> Add Sub Category</a>
                </div>
            </div>
        </div>
    </section>
	...
	?>
		...
		<div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Edit Sub Category Name</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
...
{
	$i=1;
foreach($check_subcat as $record)
{
...
<a class="btn btn-sm btn-info" href="<?php echo base_url()?>admin_adminusers/editsubcat/<?php echo $top_catid; ?>/<?php echo  base64_encode($record['cat_id']); ?>" title="Edit"><i class="fa fa-pencil"></i></a>
...
function deleteuser(del)
	{
		 var msg = 'delete this subcategory';
		 
		  if (confirm("Are you sure to " + msg)) {
           
            url = "<?php echo base_url(); ?>admin_adminusers/deletesubcategory";
            $.ajax({
                type: "POST",
                url: url,
                data: {id: del},
