    ...
    <section class="content-header">
      <h1>
        ...
        <div class="box box-primary">
                    ...
                    <form role="form" id="addUser" action="<?php echo base_url() ?>admin_adminusers/addworkcategory" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        <label for="fname">Category Name</label>
                                        <input type="text" class="form-control " value="" id="categoryname" name="categoryname" maxlength="128" required>
                                    </div>
